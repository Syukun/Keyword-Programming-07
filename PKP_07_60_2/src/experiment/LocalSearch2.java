...
//		logControl.println("  > ソートして重複文字列を削除した。 >");
		...
		logControl.println("総数\t" + result_set.size());
		logControl.println("正解出現数\t\t" + (result_set.size() - sum_m_one));
		...
		logControl.println("平均キーワード数\t" + ((double)sumKey/result_set.size()));
		logControl.println("平均ローカル型数\t" + ((double)sumLT/result_set.size()));
		logControl.println("平均ローカル関数数\t" + ((double)sumLF/result_set.size()));
