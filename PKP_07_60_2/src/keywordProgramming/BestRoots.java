...
public class BestRoots {
	...
	private static TreeMap<String, FunctionTree[][]> root_table;
	//best_r番のrootを決めるまでに候補を一時的に保存しておくオブジェクト
	//後で評価値でソートする。
	private static List<FunctionTree> tmpRoots = new ArrayList<FunctionTree>();
	private final int _BEST_R_ = KeywordProgramming.BEST_R;
	private final int _HEIGHT_ = KeywordProgramming.HEIGHT;
	
	private static int max_tmpRoots_size;
